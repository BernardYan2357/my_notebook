...
public:
    Commander(std::shared_ptr<rclcpp::Node> node)
    {
        ...
        gripper_cmd_sub_ = node_->create_subscription<Bool>(
            "cmd_gripper", 10, std::bind(&Commander::gripperCmdCallback, this, _1));
        joint_cmd_sub_ = node_->create_subscription<FloatArray>(
            "cmd_joint", 10, std::bind(&Commander::jointCmdCallback, this, _1));
        pose_cmd_sub_ = node_->create_subscription<PoseCmd>(
            "cmd_pose", 10, std::bind(&Commander::poseCmdCallback, this, _1));
    }
...
private:
    ...
    rclcpp::Subscription<Bool>::SharedPtr gripper_cmd_sub_;
